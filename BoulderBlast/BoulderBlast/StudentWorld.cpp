...
//	else return false;
//}
//bool StudentWorld::tooManyKleptos(int x, int y)
//{
//	std::vector<Actor*>::iterator one = std::find_if(m_actors.begin(), m_actors.end(), Actor::KleptoBotFactory::isRobotInArea);
//	if (one != m_actors.end())
//	{
//		std::vector<Actor*>::iterator two = std::find_if(++one, m_actors.end(), Actor::isRobotInArea);
//		if (two != m_actors.end())
//		{
//			std::vector<Actor*>::iterator three = std::find_if(++two, m_actors.end(), isRobotInArea);
//			if (three != m_actors.end())
//				return true;
//		}
//	}
//	else
